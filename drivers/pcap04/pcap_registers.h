...
union PCAP_REG_CFG1_T
{
    ...
    {
        uint8_t OX_RUN : 3;
        const uint8_t OX_STOP : 1;
        const uint8_t OX_AUTOSTOP_DIS : 1;
        uint8_t OX_DIV4 : 1;
        uint8_t RSRVD : 1;
        uint8_t OX_DIS : 1;
    } CFG1;
...
union PCAP_REG_CFG2_T
{
    ...
    {
        uint8_t RSRVD0 : 1;
        uint8_t RDCHG_EXT_EN : 1;
        uint8_t RSRVD1 : 1;
        uint8_t RDCHG_INT_EN : 1;
...
union PCAP_REG_CFG3_T
{
    ...
    {
        uint8_t RCHG_SEL : 1;
        uint8_t RDCHG_EXT_PERM : 1;
        uint8_t RDCHG_PERM_EN : 1;
        uint8_t RDCHG_OPEN : 2;
        uint8_t AUX_CINT : 1;
        uint8_t AUX_PD_DIS : 1;
        uint8_t RSRVD : 1;
    } CFG3;
};
...
union PCAP_REG_CFG4_T
{
    ...
    struct
    {
        uint8_t C_FLOATING : 1;
        uint8_t C_DIFFERENTIAL : 1;
        uint8_t RSRVD0 : 2;
        uint8_t C_COMP_INT : 1;
        uint8_t C_COMP_EXT : 1;
        uint8_t RSRVD1 : 1;
        uint8_t C_REF_INT : 1;
    } CFG4;
};
...
union PCAP_REG_CFG5_T
{
    ...
    struct
    {
        uint8_t C_DC_BALANCE : 1;
        uint8_t CY_PRE_LONG : 1;
        uint8_t CY_DIV4_DIS : 1;
        uint8_t CY_HFCLK_SEL : 1;
        uint8_t RSRVD0 : 1;
        uint8_t C_PORT_PAT : 1;
        uint8_t RSRVD1 : 1;
        uint8_t CY_PRE_MR1_SHORT : 1;
    } CFG5;
};
...
union PCAP_REG_CFG17_T
{
    ...
    struct
    {
        uint8_t FULLCHARGE_TIME_HIGH : 2;
        uint8_t C_REF_SEL : 5;
        uint8_t RSRVD : 1;
    } CFG17;
};
...
union PCAP_REG_CFG18_T
{
    ...
    {
        uint8_t C_G_EN : 6;
        uint8_t C_G_OP_EXT : 1;
        uint8_t C_G_OP_RUN : 1;
    } CFG18;
};
...
union PCAP_REG_CFG23_T
{
    ...
    struct
    {
        ...
        uint8_t R_FAKE : 1;
        uint8_t RSRVD : 1;
        uint8_t R_PORT_EN_IREF : 1;
        uint8_t R_PORT_EN_IMES : 1;
        uint8_t R_PORT_EN : 2;
    } CFG23;
};
...
union PCAP_REG_CFG24_T
{
    ...
    struct
    {
        uint8_t TDC_MUPU_SPEED : 2;
        uint8_t TDC_NOISE_DIS : 1;
        uint8_t TDC_ALUPERMOPEN : 1;
        uint8_t TDC_CHAN_EN : 2;
        uint8_t RSRVD : 2;
    } CFG24;
};
...
union PCAP_REG_CFG26_T
{
    ...
    {
        uint8_t RSRVD : 1;
        uint8_t TDC_NOISE_CY_DIS : 1;
        uint8_t TDC_QHA_SEL : 6;
    } CFG26;
};
...
union PCAP_REG_CFG30_T
{
    ...
    struct
    {
        ...
        uint8_t RSRVD : 3;
        uint8_t PG4_INTN_EN : 1;
        uint8_t PG5_INTN_EN : 1;
    } CFG30;
};
...
union PCAP_REG_CFG31_T
{
    ...
    struct
    {
        ...
        uint8_t PI0_PDM_SEL : 1;
        uint8_t PI0_RES : 2;
        uint8_t PI0_TOGGLE_EN : 1;
        uint8_t PI1_TOGGLE_EN : 1;
    } CFG31;
};
...
union PCAP_REG_CFG34_T
{
    ...
    struct
    {
        uint8_t AMS_INT_REG : 4;
        uint8_t AUTOSTART : 1;
        uint8_t BG_PERM : 1;
        uint8_t DSP_TRIG_BG : 1;
        uint8_t INT_TRIG_BG : 1;
    } CFG34;
};
...
union PCAP_REG_CFG42_T
{
    ...
    struct
    {
        uint8_t C_MEDIAN_EN : 1;
        uint8_t R_MEDIAN_EN : 1;
        uint8_t HS_MODE_SEL : 1;
        uint8_t EN_ASYNC_READ : 1;
        uint8_t ALARM0_SELECT : 1;
        uint8_t RSRVD0 : 1;
        uint8_t ALARM1_SELECT : 1;
        uint8_t RSRVD1 : 1;
    } CFG42;
};
...
union PCAP_REG_STATUS0_T
{
    ...
    struct
    {
        ...
        uint8_t POR_CDC_DSP_COLL : 1;
        uint8_t POR_FLAG_CONFIG : 1;
        uint8_t POR_FLAG_WDOG : 1;
    } STATUS0;
};
...
union PCAP_REG_STATUS2_T
{
    ...
    struct
    {
        uint8_t C_PORTERR0 : 1;
        uint8_t C_PORTERR1 : 1;
        uint8_t C_PORTERR2 : 1;
        uint8_t C_PORTERR3 : 1;
        uint8_t C_PORTERR4 : 1;
        uint8_t C_PORTERR5 : 1;
        uint8_t C_PORTERR_INT : 1;
        uint8_t RSRVD : 1;
    } STATUS2;
};

typedef struct __PCAP_RESULTS_REGS_T
{
    union PCAP_REG_RES0_T RES0;
    union PCAP_REG_RES1_T RES1;
    union PCAP_REG_RES2_T RES2;
    union PCAP_REG_RES3_T RES3;
    union PCAP_REG_RES4_T RES4;
    union PCAP_REG_RES5_T RES5;
    union PCAP_REG_RES6_T RES6;
    union PCAP_REG_RES7_T RES7;
    union PCAP_REG_STATUS0_T STATUS0;
    union PCAP_REG_STATUS1_T STATUS1;
    union PCAP_REG_STATUS2_T STATUS2;
} RESULT_REGS_packed;

// Define config registers structure
typedef struct __PCAP_CONFIG_REGS_T
{
    union PCAP_REG_CFG0_T CFG0;
    union PCAP_REG_CFG1_T CFG1;
    union PCAP_REG_CFG2_T CFG2;
    union PCAP_REG_CFG3_T CFG3;
    union PCAP_REG_CFG4_T CFG4;
    union PCAP_REG_CFG5_T CFG5;
    union PCAP_REG_CFG6_T CFG6;
    union PCAP_REG_CFG7_T CFG7;
    union PCAP_REG_CFG8_T CFG8;
    union PCAP_REG_CFG9_T CFG9;
    union PCAP_REG_CFG10_T CFG10;
    union PCAP_REG_CFG11_T CFG11;
    union PCAP_REG_CFG12_T CFG12;
    union PCAP_REG_CFG13_T CFG13;
    union PCAP_REG_CFG14_T CFG14;
    union PCAP_REG_CFG15_T CFG15;
    union PCAP_REG_CFG16_T CFG16;
    union PCAP_REG_CFG17_T CFG17;
    union PCAP_REG_CFG18_T CFG18;
    union PCAP_REG_CFG19_T CFG19;
    union PCAP_REG_CFG20_T CFG20;
    union PCAP_REG_CFG21_T CFG21;
    union PCAP_REG_CFG22_T CFG22;
    union PCAP_REG_CFG23_T CFG23;
    union PCAP_REG_CFG24_T CFG24;
    union PCAP_REG_CFG25_T CFG25;
    union PCAP_REG_CFG26_T CFG26;
    union PCAP_REG_CFG27_T CFG27;
    union PCAP_REG_CFG28_T CFG28;
    union PCAP_REG_CFG29_T CFG29;
    union PCAP_REG_CFG30_T CFG30;
    union PCAP_REG_CFG31_T CFG31;
    union PCAP_REG_CFG32_T CFG32;
    union PCAP_REG_CFG33_T CFG33;
    union PCAP_REG_CFG34_T CFG34;
    union PCAP_REG_CFG35_T CFG35;
    union PCAP_REG_CFG36_T CFG36;
    union PCAP_REG_CFG37_T CFG37;
    union PCAP_REG_CFG38_T CFG38;
    union PCAP_REG_CFG39_T CFG39;
    union PCAP_REG_CFG40_T CFG40;
    union PCAP_REG_CFG41_T CFG41;
    union PCAP_REG_CFG42_T CFG42;
    union PCAP_REG_CFG43_T CFG43;
    union PCAP_REG_CFG44_T CFG44;
    union PCAP_REG_CFG45_T CFG45;
    union PCAP_REG_CFG46_T CFG46;
    union PCAP_REG_CFG47_T CFG47;
    union PCAP_REG_CFG48_T CFG48;
    union PCAP_REG_CFG49_T CFG49;
    union PCAP_REG_CFG50_T CFG50;
    union PCAP_REG_CFG51_T CFG51;
    union PCAP_REG_CFG52_T CFG52;
    union PCAP_REG_CFG53_T CFG53;
    union PCAP_REG_CFG54_T CFG54;
    union PCAP_REG_CFG55_T CFG55;
    union PCAP_REG_CFG56_T CFG56;
    union PCAP_REG_CFG57_T CFG57;
    union PCAP_REG_CFG58_T CFG58;
    union PCAP_REG_CFG59_T CFG59;
    union PCAP_REG_CFG60_T CFG60;
    union PCAP_REG_CFG61_T CFG61;
    union PCAP_REG_CFG62_T CFG62;
    union PCAP_REG_CFG63_T CFG63;
} CONFIG_REGS_packed;

typedef struct __PCAP_CONFIG_REGS_T* pcap_config_handler_t;

// Define FW structs with arrays for firmware data
typedef struct __PCAP_FW_T
{
    uint8_t data[PCAP_NVRAM_FW_SIZE];
} _FW_packed;

typedef struct __PCAP_FW_CAL0_T
{
    uint8_t data[PCAP_NVRAM_FW_CAL0_SIZE];
} _FW_CAL0_packed;

typedef struct __PCAP_FW_CAL1_T
{
    uint8_t data[PCAP_NVRAM_FW_CAL1_SIZE];
} _FW_CAL1_packed;

// Define the full NVRAM structure
typedef struct __PCAP_NVRAM_T
{
    struct __PCAP_FW_T FW;
    struct  __PCAP_FW_CAL0_T FW_CAL0;
    struct __PCAP_FW_CAL1_T FW_CAL1;
    struct  __PCAP_CONFIG_REGS_T CFG;
} PCAP_NVRAM_packed;
